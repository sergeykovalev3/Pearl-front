...
/** Scroll-triggered headline + paragraph clip reveal. */
...
export function BlogPostPage({ article }: { article: Article }) {
  ...
  const bodyParagraphs = paragraphsFromBody(article.text);
        ...
        >
          ...
          >
            <Image
              ...
              sizes="(max-width: 1280px) min(100vw - 30px, 1280px), 1250px"
              priority
            />
          </motion.div>
          <motion.div
